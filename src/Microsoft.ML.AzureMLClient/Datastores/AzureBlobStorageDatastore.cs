// <copyright file="AzureBlobStorageDatastore.cs" company="Microsoft">
...
{
    public class AzureBlobStorageDatastore : Datastore
    {
        /// <summary>
        /// Initializes a new instance of the AzureBlobStorageDatastore class.
        /// </summary>
        ...
        public override GeneratedOld.Models.DataStore ToDto()
        {
            ...
            dto.DataStoreType = Datastore.DatastoreType.AzureBlob.ToString();
