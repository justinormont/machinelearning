...
namespace Azure.MachineLearning.Services.GeneratedOld.Models
{
    ...
    public partial class ACIServiceResponse : ServiceResponseBase
    {
        ...
        /// <param name="servingContainerInferenceConfiguration">The Image
        ...
        public ACIServiceResponse(System.DateTime? createdTime = default(System.DateTime?), DeploymentType? deploymentType = default(DeploymentType?), string description = default(string), ModelErrorResponse error = default(ModelErrorResponse), string id = default(string), IDictionary<string, string> kvTags = default(IDictionary<string, string>), string name = default(string), IDictionary<string, string> properties = default(IDictionary<string, string>), WebServiceState? state = default(WebServiceState?), IList<string> tags = default(IList<string>), System.DateTime? updatedTime = default(System.DateTime?), ContainerResourceRequirements containerResourceRequirements = default(ContainerResourceRequirements), string imageId = default(string), ServingContainerInferenceConfiguration servingContainerInferenceConfiguration = default(ServingContainerInferenceConfiguration), DockerImageResponse imageDetails = default(DockerImageResponse), string scoringUri = default(string), string location = default(string), bool? authEnabled = default(bool?), bool? sslEnabled = default(bool?), bool? appInsightsEnabled = default(bool?), ModelDataCollection dataCollection = default(ModelDataCollection), string sslCertificate = default(string), string sslKey = default(string), string cname = default(string), string publicIp = default(string), string swaggerUri = default(string), IDictionary<string, object> modelConfigMap = default(IDictionary<string, object>))
            : base(createdTime, deploymentType, description, error, id, kvTags, name, properties, state, tags, updatedTime)
        {
            ContainerResourceRequirements = containerResourceRequirements;
            ImageId = imageId;
            ServingContainerInferenceConfiguration = servingContainerInferenceConfiguration;
        ...
        /// </summary>
        [JsonProperty(PropertyName = "servingContainerInferenceConfiguration")]
        public ServingContainerInferenceConfiguration ServingContainerInferenceConfiguration { get; set; }
        ...
        {
            base.Validate();
            if (ServingContainerInferenceConfiguration != null)
            {
                ServingContainerInferenceConfiguration.Validate();
            }
