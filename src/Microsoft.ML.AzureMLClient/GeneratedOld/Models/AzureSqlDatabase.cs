...
namespace Azure.MachineLearning.Services.GeneratedOld.Models
{
    ...
    public partial class AzureSqlDatabase
    {
        /// <summary>
        /// Initializes a new instance of the AzureSqlDatabase class.
        /// </summary>
        ...
        /// Initializes a new instance of the AzureSqlDatabase class.
        /// </summary>
        /// <param name="serverName">The Azure SQL server name</param>
        /// <param name="databaseName">The Azure SQL database name</param>
        /// <param name="endpoint">The server host endpoint</param>
        ...
        /// <summary>
        /// Gets or sets the Azure SQL server name
        /// </summary>
        [JsonProperty(PropertyName = "serverName")]
        public string ServerName { get; set; }

        /// <summary>
        /// Gets or sets the Azure SQL database name
        /// </summary>
        [JsonProperty(PropertyName = "databaseName")]
        public string DatabaseName { get; set; }

        /// <summary>
        /// Gets or sets the server host endpoint
        /// </summary>
