...
namespace Azure.MachineLearning.Services.GeneratedOld.Models
{
    ...
    public partial class DataLakeAnalytics : Compute
    {
        ...
        public DataLakeAnalytics(string computeLocation = default(string), ProvisioningState? provisioningState = default(ProvisioningState?), string description = default(string), System.DateTime? createdOn = default(System.DateTime?), System.DateTime? modifiedOn = default(System.DateTime?), string resourceId = default(string), IList<MachineLearningServiceError> provisioningErrors = default(IList<MachineLearningServiceError>), bool? isAttachedCompute = default(bool?), DataLakeAnalyticsProperties properties = default(DataLakeAnalyticsProperties))
