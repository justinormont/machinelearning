...
namespace Azure.MachineLearning.Services.GeneratedOld.Models
{
    ...
    public partial class VirtualMachineSize
    {
        ...
        public VirtualMachineSize(string name = default(string), string family = default(string), int? vCPUs = default(int?), int? osVhdSizeMB = default(int?), int? maxResourceVolumeMB = default(int?), double? memoryGB = default(double?), bool? lowPriorityCapable = default(bool?), bool? premiumIO = default(bool?))
        {
            Name = name;
            Family = family;
            VCPUs = vCPUs;
