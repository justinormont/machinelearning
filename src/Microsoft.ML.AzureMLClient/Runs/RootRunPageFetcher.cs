// <copyright file="RootRunPageFetcher.cs" company="Microsoft">
...
{
    public class RootRunPageFetcher : RunPageFetcher
    {
        public RootRunPageFetcher(
            ...
            CancellationToken cancellationToken)
        {
            ...
            PaginatedRunDto response = await RestCallWrapper.WrapAsync(
                () => restClient.Run.ListWithHttpMessagesAsync(
