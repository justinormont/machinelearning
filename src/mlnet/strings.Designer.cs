...
namespace Microsoft.ML.CLI {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Specify on/off/auto for cache to be turned on, off, or auto-determined (default)..
        /// </summary>
        internal static string CacheHelperText {
            get {
                return ResourceManager.GetString("CacheHelperText", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Name for output project or solution to create. Default is SampleClassification..
        /// </summary>
        internal static string ClassificationNameHelperText {
            get {
                return ResourceManager.GetString("ClassificationNameHelperText", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to File path to single dataset or training dataset for train/test approaches. Required..
        /// </summary>
        internal static string DatasetHelperText {
            get {
                return ResourceManager.GetString("DatasetHelperText", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Detect result for input file is {0} while your input is {1}. Please double check to confirm..
        /// </summary>
        internal static string HeaderDetectionWarning {
            get {
                return ResourceManager.GetString("HeaderDetectionWarning", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Specify true/false depending if dataset file(s) have header row. Default is true..
        /// </summary>
        internal static string HeaderHelperText {
            get {
                return ResourceManager.GetString("HeaderHelperText", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Specify columns to be ignored in given dataset. Use comma-separated column names or indices..
        /// </summary>
        internal static string IgnoreColsHelperText {
            get {
                return ResourceManager.GetString("IgnoreColsHelperText", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Name or index of item column. Items are recommended to users..
        /// </summary>
        internal static string ItemColHelperText {
            get {
                return ResourceManager.GetString("ItemColHelperText", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Name or index of label (target) column to predict..
        /// </summary>
        internal static string LabelColHelperText {
            get {
                return ResourceManager.GetString("LabelColHelperText", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string LogFilePathHelperText {
            get {
                return ResourceManager.GetString("LogFilePathHelperText", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Location folder for generated output. Default is current directory..
        /// </summary>
        internal static string OutputHelperText {
            get {
                return ResourceManager.GetString("OutputHelperText", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Name or index of ratings (target) column to predict..
        /// </summary>
        internal static string RatingColHelperText {
            get {
                return ResourceManager.GetString("RatingColHelperText", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Name for output project or solution to create. Default is SampleRecommendation..
        /// </summary>
        internal static string RecommendationNameHelperText {
            get {
                return ResourceManager.GetString("RecommendationNameHelperText", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Name for output project or solution to create. Default is SampleRegression..
        /// </summary>
        internal static string RegressionNameHelperText {
            get {
                return ResourceManager.GetString("RegressionNameHelperText", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to File path for test dataset in train/test approaches..
        /// </summary>
        internal static string TestDatasetHelperText {
            get {
                return ResourceManager.GetString("TestDatasetHelperText", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Unable to load data from {0}. Please ensure file has a header row (column names) as the first row and is a properly formatted tsv, csv or txt file..
        /// </summary>
        internal static string TextFileError {
            get {
                return ResourceManager.GetString("TextFileError", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Maximum time in seconds for exploring models with best configuration. Default time is 10 sec..
        /// </summary>
        internal static string TrainTimeHelperText {
            get {
                return ResourceManager.GetString("TrainTimeHelperText", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Name or index of user column. Users receive recommended items..
        /// </summary>
        internal static string UserColHelperText {
            get {
                return ResourceManager.GetString("UserColHelperText", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to File path for validation dataset in train/validate/test approaches..
        /// </summary>
        internal static string ValidationDatasetHelperText {
            get {
                return ResourceManager.GetString("ValidationDatasetHelperText", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Output verbosity choices: q[uiet], m[inimal] (default) and diag[nostic]..
        /// </summary>
        internal static string VerbosityHelperText {
            get {
                return ResourceManager.GetString("VerbosityHelperText", resourceCulture);
            }
        }
